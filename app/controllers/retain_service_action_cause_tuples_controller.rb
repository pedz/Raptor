class RetainServiceActionCauseTuplesController < ApplicationController
  # GET /retain_service_action_cause_tuples
  # GET /retain_service_action_cause_tuples.xml
  def index
    @retain_service_action_cause_tuples = RetainServiceActionCauseTuple.find(:all)
  ...
  def show
    @retain_service_action_cause_tuple = RetainServiceActionCauseTuple.find(params[:id])
  ...
  def new
    @retain_service_action_cause_tuple = RetainServiceActionCauseTuple.new
  ...
  def create
    @retain_service_action_cause_tuple = RetainServiceActionCauseTuple.new(params[:retain_service_action_cause_tuple])

    respond_to do |format|
      if @retain_service_action_cause_tuple.save
        flash[:notice] = 'RetainServiceActionCauseTuple was successfully created.'
  ...
  def update
    ...
    respond_to do |format|
      if @retain_service_action_cause_tuple.update_attributes(params[:retain_service_action_cause_tuple])
        flash[:notice] = 'RetainServiceActionCauseTuple was successfully updated.'
        format.html { redirect_to(@retain_service_action_cause_tuple) }
        format.xml  { head :ok }
      else
