...
module Retain
  class Fields
    ...
    FIELD_DEFINITIONS = {
      ...
      :call_received_time          => [ 1386, :ebcdic,          2 ],
      :actual_local_time           => [ 1387, :ebcdic,          2 ],
      :psi_time_hex                => [ 1388, :ebcdic,          2 ],
      :travel_time                 => [ 1389, :ebcdic,          2 ],
      ...
      :overtime_hex                => [ 1394, :ebcdic,          2 ],
      :travel_overtime_hex         => [ 1395, :ebcdic,          2 ],
      :chargeable_time_hex         => [ 1396, :ebcdic,          2 ],
      :after_hours_time_hex        => [ 1397, :ebcdic,          2 ],
      :local_stop_time_hex         => [ 1398, :ebcdic,          2 ],
