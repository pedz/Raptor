...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should show relationship" do
    get :show, :id => relationships(:one).to_param
    assert_response :success
  end

  test "should get edit" do
    get :edit, :id => relationships(:one).to_param
    assert_response :success
  end

  test "should update relationship" do
    put :update, :id => relationships(:one).to_param, :relationship => { }
    assert_redirected_to relationship_path(assigns(:relationship))
  end

  test "should destroy relationship" do
    assert_difference('Relationship.count', -1) do
      delete :destroy, :id => relationships(:one).to_param
    end
