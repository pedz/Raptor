...
%w{5000 5001}.each do |port|
  God.watch do |w|
    ...
    w.start = "script/rvm-wrapper thin --port #{port} --environment development --prefix /raptor --log log/thin.5000.log --pid tmp/pids/thin.5000.pid --chdir #{RAILS_ROOT} start"
